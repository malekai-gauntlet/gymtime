...
Solution: Save time and effort with voice based tracking in the app + through an easy iOS shortcut. Engage users with in-app peer competition + AI injury prevention analysis.

Validation: I want this myself + multiple friends tell me they want this too
...
I want to see what imbalances or overuse injuries I’m at risk of based on my training — as well as counter exercises to compensate — so I remain durable
I want to see a summary of my workouts and progression so I can stay motivated
...
I want to compete with friends & strangers through leaderboards + gamify the competition (e.g. see a race car around the track based on total weight lifted that week)
